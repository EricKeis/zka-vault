...
INSERT INTO "new_Vault" ("aes256Iv", "aes256KeySalt", "data", "id", "name", "passwordHash", "passwordSalt") SELECT "aes256Iv", "aes256KeySalt", "data", "id", "name", "passwordHash", "passwordSalt" FROM "Vault";
DROP TABLE "Vault";
